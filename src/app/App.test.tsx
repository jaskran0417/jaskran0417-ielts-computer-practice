...
describe('App session flow', () => {
  ...
  it('opens the importer as a real workspace section', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'Import and verify test material' })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /Sessions/i })).toBeInTheDocument();
    expect(screen.queryByRole('heading', { name: 'Create a test session' })).not.toBeInTheDocument();
  });
